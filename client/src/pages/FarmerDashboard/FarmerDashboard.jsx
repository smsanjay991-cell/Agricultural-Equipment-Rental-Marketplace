...
import { Calendar, Clock, CheckCircle, XCircle, AlertCircle, Phone, MapPin, IndianRupee } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <div className="glass-panel px-4 py-2 rounded-xl border border-slate-800 text-center">
            <span className="block text-slate-400">Active / Approved</span>
